<template>
  ...
  >
    ...
    <g filter="url(#filter1_f_19_796)">
      <ellipse cx="53.5" cy="72.5" rx="31.5" ry="9.5" fill="#004E67" fill-opacity="0.7" />
    </g>
    ...
    <defs>
      ...
      >
        ...
        <feComposite in2="SourceAlpha" operator="in" result="effect1_backgroundBlur_19_796" />
        <feBlend
          mode="normal"
          in="SourceGraphic"
        ...
        <feBlend mode="normal" in2="shape" result="effect2_innerShadow_19_796" />
      </filter>
      <filter
        id="filter1_f_19_796"
        x="0"
      ...
      >
        ...
        <feGaussianBlur stdDeviation="11" result="effect1_foregroundBlur_19_796" />
      </filter>
      <filter
